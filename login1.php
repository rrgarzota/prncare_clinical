                        ...
                        <div class="row" style="min-height:577px;">
                            <div class="col-lg-7">
                                ...
                                <div class="cb-login-res-px cb-login-res-py text-center">
                                    <h5 class="d-none d-lg-block cb-text-sea-green cb-font-weight-800 cb-text-size-2 mb-5">Sign in to Caspio</h5>   
                                    <div class="cb-btn-rounded-1-5 cb-btn-w-45 cb-btn-py-2 cb-font-weight-800 cb-btn-sea-green cb-fields-bg-sea-green cb-text-size-1">
                                    ...
                                    <div class="mt-3 d-block d-lg-none">
                                        <p class="cb-text-light-grey">Not a member?<a href="./registration1.php"> Join today!</a></p>
                                    </div>                      
                                </div>
                            </div>
                            <div class="col-lg-5 d-none d-lg-block bg-login-image-green  cb-rounded-right-1-5">
                                ...
                                <div class="px-5 cb-py-8 text-center">
                                    ...
                                    <div class="row">
                                        <div class="col-12 col-lg-8 offset-lg-2 col-md-10 offset-md-1">
                                            <button class="btn cb-btn-outline-sea-green cb-rounded-1-5 w-100 py-2 cb-font-weight-800" onclick="window.location.href='./registration1.php'">SIGN UP</button>
                                        </div>
                                    </div>
                                </div>
