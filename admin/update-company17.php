            ...
            <section class="content">
                ...
                <div class="<?php echo $container ;?>">
                    <div class="row">
                        <div class="col-12">
                            <!-- Default box -->
                            <div class="card shadow mb-4 center-aligned-card">
                                <div class="card-body cb-edit-form cb-fields-shadow-blue cb-form-divider-blue cb-form-divider-blue cb-form-btn-right cb-btn-radius-1-5">
                                    <script type="text/javascript" src="https://c2axa202.caspio.com/dp/caf26000f0bdf03b61e04f8f812c/emb"></script>
                                </div>
                                <!-- /.card-body -->
                            </div>
                            <!-- /.card -->
