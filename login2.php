                        ...
                        <div class="row" style="min-height:577px;">
                            <div class="col-lg-6">
                                ...
                                <div class="cb-login-res-px cb-login-res-py text-center">
                                    ...
                                    <div class="cb-btn-rounded-1-5 cb-btn-w-45 cb-btn-py-2 cb-btn-blue cb-fields-bg-blue cb-text-size-1">
                                        <script type="text/javascript" src="https://c1hck776.caspio.com/dp/d09ac000e3043d37edd14e62a30a/emb"></script>                                    
                                    </div>    
                                    ...
                                    <div class="mt-3 d-block ">
                                        <p class="cb-text-light-grey">Not a member?<a href="./registration2.php"> Join today!</a></p>
                                    </div>                      
                                </div>
                            </div>
                            <div class="col-lg-6 d-none d-lg-block bg-login-image-blue  cb-rounded-right-1-5">
