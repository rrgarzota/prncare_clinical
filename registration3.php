                ...
                <div class="card border-0 shadow-lg public-wrapper cb-rounded-1">
                    <div class="card-body p-0">
                        ...
                        <div class="row" style="min-height:577px;">
                            <div class="col-lg-5 d-none d-lg-block bg-login-image-orange cb-rounded-left-1-5">
                                ...
                                <div class="px-5 cb-py-6-5 text-center">
                                    ...
                                    <div class="row">
                                        <div class="col-12 col-lg-8 offset-lg-2 col-md-10 offset-md-1">
                                            <button class="btn cb-btn-outline-orange cb-rounded-1-5 w-100 py-2 cb-font-weight-800" onclick="window.location.href='./login3.php'">SIGN IN</button>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-7">
                                ...
                                <div class="cb-form-res-px cb-form-res-py text-center">
                                    <h5 class="d-none d-lg-block cb-text-orange cb-font-weight-800 cb-text-size-2 mb-5">Create Account</h5>   
                                    <div class="cb-btn-rounded-1-5 cb-btn-w-50 cb-btn-py-2 cb-font-weight-800 cb-btn-orange cb-fields-bg-orange cb-text-size-1">
                                    ...
                                    <div class="d-block d-lg-none mt-3">
                                        <p class="cb-text-light-grey">Already have an account? <strong><a href="./login3.php">SIGN IN</a></strong></p>
                                    </div>                      
                                </div>
                            </div>
                        </div>
